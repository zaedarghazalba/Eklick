...
<body>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#hero">Antrian</a></li>
      ...
      <a href="sso-callback" class="appointment-btn scrollto">Login/Register</a>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      ...
      <a href="/sso-google" class="btn-get-started scrollto">Ambil Antrian</a>
    </div>
  </section><!-- End Hero -->
