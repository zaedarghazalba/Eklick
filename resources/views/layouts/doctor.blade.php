...
<head>
  ...
  <title>{{ $title ?? 'Doctor Dashboard - Klinik PUI' }}</title>
  <meta content="{{ $description ?? 'Doctor Dashboard Klinik PUI' }}" name="description">
...
<body>
  ...
  <!-- Header -->
  <x-doctor-header :title="$headerTitle ?? 'Eklick Dokter'" />
  ...
  <!-- Footer -->
  @include('partials.doctor-footer')
