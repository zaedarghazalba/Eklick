...
<head>
  ...
  <title>Tambah Dokter - Admin Dashboard</title>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9">
                    <select class="form-select" id="poli_spesialisasi" name="poli_spesialisasi" required>
                      ...
                      <option value="Umum" {{ old('poli_spesialisasi') == 'Umum' ? 'selected' : '' }}>Poli Umum</option>
                      <option value="Tht" {{ old('poli_spesialisasi') == 'Tht' ? 'selected' : '' }}>Poli THT</option>
                      <option value="Syaraf" {{ old('poli_spesialisasi') == 'Syaraf' ? 'selected' : '' }}>Poli Syaraf</option>
                      <option value="Balita" {{ old('poli_spesialisasi') == 'Balita' ? 'selected' : '' }}>Poli Balita</option>
                      <option value="Kulit" {{ old('poli_spesialisasi') == 'Kulit' ? 'selected' : '' }}>Poli Kulit dan Kelamin</option>
                      <option value="Mata" {{ old('poli_spesialisasi') == 'Mata' ? 'selected' : '' }}>Poli Mata</option>
                    </select>
                  </div>
                </div>
