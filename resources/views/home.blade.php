    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#services">Antrian</a></li>
...
@endif
      ...
      <button type="button" class="btn-get-started scrollto border-0" data-bs-toggle="modal" data-bs-target="#ambilAntrian">
        Ambil Antrian
      </button>
      <a href="/antrian" class="btn-get-started scrollto">Cek Kuota</a>
    </div>
  </section><!-- End Hero -->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="ambilAntrianLabel">Form Antrian</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form id="antrianForm" action="{{ route('antrian.send') }}" method="POST">            
              @csrf                
              <div class="form-group">
                  <label for="poli">Ambil Antrian Untuk Poli</label>
              ...
              <div class="form-group">
                <label for="tanggal_daftar">Pilih Tanggal Antrian</label>
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Poli EKlick</h2>
          <p>
            Klinik Tarakan memiliki 6 poli kesehatan 
          </p>
        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="content">
              ...
              <!-- Tambahkan lebih banyak konten di sini jika diperlukan -->
              <p>
                Selain itu, kami juga menyediakan layanan darurat 24 jam dan fasilitas penunjang medis lainnya.
              </p>
              <p>
                Untuk informasi lebih lanjut, silakan hubungi kami di nomor telepon yang tertera atau datang langsung ke klinik kami.
              </p>
            </div>
          </div>
              ...
              <div class="row">
                <div class="col-xl-4 d-flex align-items-stretch mb-4">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>Layanan Konsultasi Kesehatank</h4>
                    </p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch mb-4">
                ...
                <div class="col-xl-4 d-flex align-items-stretch mb-4">
                  <div class="icon-box mt-4 mt-xl-0">
                    <i class="bx bx-images"></i>
                    <h4>Layanan Pemeriksaan KeRumah</h4>
                    <p>
                    </p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch mb-4">
                  <div class="icon-box mt-4 mt-xl-0">
                    <i class="bx bx-images"></i>
                    <h4>Layanan Ramah Disabilitas</h4>
                    <p>
                    </p>
                  </div>
                </div>
